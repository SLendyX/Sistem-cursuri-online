// client/src/CourseCard.jsx (Fixed - No nested links)
...
export default function CourseCard({ curs, ...props }) {
  const navigate = useNavigate();
  const { nume_curs, thumbnail_url, dificultate, nr_proiecte, studenti_inrolati, descriere, pret, rating, curs_id, name, autor_id } = curs;

  const dificulty_color = dificultate === "usor" ? "success" : dificultate === "mediu" ? "warning" : "error";

  // Handle card click - navigate to course page
  const handleCardClick = () => {
    navigate(`/courses/${curs_id}`);
  };
